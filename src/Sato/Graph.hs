...
--
-- "Sato.Graph" is modified from "Distribution.Compat.Graph" in @Cabal@ package
--
...
import qualified Futurice.Prelude as Prelude
...
-}
    ...
    null   = Prelude.null   . graphMap
    toList = Prelude.toList . graphMap
